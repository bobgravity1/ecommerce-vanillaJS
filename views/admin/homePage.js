...
module.exports=({req, products})=>{
  const renderedProducts = products
    ...
    if(!req.session.userId){
      return layout({
        content:`
      // <h1 class='user'>You are not currently signed in</h1>
      ...
      <a class="dropdown-item" href="#">Forgot password?</a>
        ...
        <div class="shell">
          ...
          <div id="header">
            ...
            <div id="navigation">
              <ul>
                <li><a href="/admin/products" >Admin Editer</a></li>
              </ul>
            </div>
            </div>
            <!-- End Header -->
      ...
      return layout({
        content:`
      // <h1 class='user'>You are currently logged in as Admin User:${req.session.userId.toUpperCase()}</h1>
      <div class="dropdown-divider"></div>
